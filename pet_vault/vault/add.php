...
<!DOCTYPE html>
<!-- Add passwords to your Pet Vault. -->
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <ul class='nav'>
        ...
        <li><a class="active" href="#">Add Password</a></li>
    ...
    <div class='center'>
        <h1>Pet Vault Add Password</h1>
        <h3>Once you fill out the following form, your password will be added to your account.</h3>
        <span class="required_field">* Denotes Required Field</span>
        <form method="post" action="<?php echo htmlspecialchars('passwords.php');?>" id = "password_enter" name='password_enter' class='password_enter' onsubmit='return valid()'>
            <ul>
                <li class="first_item">
